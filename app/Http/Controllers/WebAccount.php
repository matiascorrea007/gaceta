...
class WebAccount extends BaseController
{
    /**
    ...
    public function MyAccount()
    {
        ...
        return view('shop.myaccount-perfil',compact('perfils','user','total','cartcount'));
    }
...
public function MyAccountConfig()
    {
        ...
        return view('shop.myaccount-config',compact('datosfacturacions','total','cartcount'));
...
public function DatosDeFacturacionCheckout(request $request)
 ...
 /*---------------------------------Listar Facturas--------------------------------------*/
    public function verFacturas(request $request){
        ...
        return view('shop.myaccount-facturas',compact('total','cartcount','ventas','transactions'));
...
public function MyAccountTicket(){
        ...
        return view('shop.myaccount-ticket',compact('category','prioridades','tickets','total','cartcount'));
...
public function MyAccountTicketResponder($id){
        ...
        return view('shop.myaccount-ticket-responder',compact('comentarios','ticket','total','cartcount'));
...
/*---------------------------------PUNTOS--------------------------------------*/
    public function MyAccountPuntos()
    {
       //llama a la funcion CartTotal
        ...
        return view('shop.myaccount-puntos',compact('user','total','cartcount'));

...
<div class="item item-carousel">
	...
	<h3 class="name"><a href="item-detalle-{{ $nuevo->slug }}">{{$nuevo->descripcion}}</a></h3>
			...
			<li class="add-cart-button btn-group">
				...
				<button onclick="AgregarItem({{$nuevo->id}});"  class="btn btn-primary" type="button" >Agregar</button>
			</li>  
			@else
			<li class="add-cart-button btn-group">
				<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
...
<div class="item item-carousel">
	...
	<h3 class="name"><a href="item-detalle-{{ $sale->slug }}">{{$sale->descripcion}}</a></h3>
			...
			<li class="add-cart-button btn-group">
				...
				<button onclick="AgregarItem({{$sale->id}});"  class="btn btn-primary" type="button" >Agregar</button>
			</li>  
			@else
			<li class="add-cart-button btn-group">
				<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
	...
	<div class="product">
		...
		<h3 class="name"><a href="item-detalle-{{ $hot->slug }}">{{$hot->descripcion}}</a></h3>
			...
			<li class="add-cart-button btn-group">
				...
				<button onclick="AgregarItem({{$hot->id}});"  class="btn btn-primary" type="button" >Agregar</button>
			</li>  
			@else
			<li class="add-cart-button btn-group">
				<button class="btn btn-primary icon" data-toggle="dropdown" type="button">

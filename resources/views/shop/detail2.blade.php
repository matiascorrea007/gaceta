...
<div class="cart col-md-12 col-lg-6 clearfix animate-effect">
  <div class="action">
  @if($itemdetalle->stockactual > 2)
	<button onclick="AgregarItem({{$itemdetalle->id}});"  class="btn btn-success icon" type="button" ><i class="fa fa-shopping-cart"></i> Agregar</button>
	 
   @elseif($itemdetalle->stockactual == 0)							
	<a href="#"	class="btn btn-danger icon" type="button">
	<i class="fa fa-shopping-cart"></i> AGOTADO</a>
	@elseif($itemdetalle->stockactual <= 2)
  <button onclick="AgregarItem({{$itemdetalle->id}});"  class="btn btn-warning icon" type="button" ><i class="fa fa-shopping-cart"></i> AGREGAR</button>
	@endif
...
<div class="item item-carousel">
  ...
  <h3 class="name"><a href="item-detalle-{{ $productosRelacionado->slug }}">{{$productosRelacionado->descripcion}}</a></h3>
      ...
      <li class="add-cart-button btn-group">
        ...
        <button onclick="AgregarItem({{$productosRelacionado->id}});"  class="btn btn-primary" type="button" >Agregar</button>
      </li>  
      @else
      <li class="add-cart-button btn-group">
        <button class="btn btn-primary icon" data-toggle="dropdown" type="button">

...
<html lang="en">
    <head>
        ...
        {!!Html::style('shop/css/toastr.css')!!}
            ...
            <div class="items-cart-inner">
                <div class="total-price-basket">
                    ...
                    <span class="total-price">
                        ...
                        <span class="value " id="valor_total"  >{!! $total !!}</span>
                    </span>
                </div>
                <div class="basket">
                    <i class="glyphicon glyphicon-shopping-cart"></i>
                </div>
                <div class="basket-item-count"><span class="count"  id="cantidad_total">{{ $cartcount }}</span></div>
...
<!-- ============================================================= FOOTER : END============================================================= -->
   ...
   <!--  <script src="shop/js/checkout.js"></script> -->
    ...
    <script src="shop/js/mis-funciones.js"></script>
    <script src="shop/js/toastr.js"></script>

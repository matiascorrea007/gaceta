...
<div class="modal fade " id="status-{{ $factura->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDelete">
...
<div class="container">
  {!!Form::open(['url'=>['factura-cambiar-status',$factura->id], 'method'=>'POST' ])!!}

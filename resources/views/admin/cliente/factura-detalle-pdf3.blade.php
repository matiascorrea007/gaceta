...
#FORM_55 {
    color: rgb(51, 51, 51);
    width: 974px;
    perspective-origin: 487px 0px;
    transform-origin: 487px 0px;
...
#DIV_3 {
    ...
    box-shadow: rgba(2, 2, 2, 0.298039) 0px 0px 6px 10px, rgba(0, 0, 0, 0.298039) 0px 20px 20px -5px;
    color: rgb(0, 0, 0);
    ...
    background: rgb(255, 255, 255) url(storage/1.png) repeat scroll 0px 0px / auto padding-box border-box;
...
@foreach($facturas as $factura)
  ...
  <div id="DIV_53">
    <div id="DIV_54">
      <form action="/mnyfe/secure/purchasev4" method="POST" name="purchaseInfoV4Form" id="FORM_55">
        <div id="DIV_1">
          <div id="DIV_2">
            <div id="DIV_3">
              <div id="DIV_4">
              ...
              <div id="DIV_9">
                <table id="TABLE_10">
                  <tbody id="TBODY_11">
                  <tr id="TR_16">
                      <td colspan="3" id="TD_17">
                        <ul id="UL_18">
                          <li id="LI_19">
                            Reparto de Gacetas Ramon Centeno
                          </li>
                          <li id="LI_19">
                    ...
                    <tr id="TR_16">
                      <td colspan="3" id="TD_17">
                        <ul id="UL_18">
                          <li id="LI_19">
                    Nombre : {{$factura->cliente->nombre}} -- Apellido : {{$factura->cliente->apellido}}
                          </li>
                          <li id="LI_19">
                    ...
                    <tr id="TR_29">
                      ...
                      <td id="TD_31">
                        ...
                        <tr>
                            <th>{{$factura->cantidad}} gacetas entregadas</th>
                            <th>${{$factura->total}}</th>
                        </tr>

                    <tr id="TR_24">
                      <td colspan="3" id="TD_25">
                        <ul id="UL_26">
                          <li id="LI_27">
                  ...
                  <tfoot id="TFOOT_28">
                    ...
                    <tr id="TR_45">
                      <th id="TH_46">
                        <span id="SPAN_47">Software Diseñado por</span>
                      </th>
                      <td id="TD_50">
                        <span id="SPAN_51">Sharkestudio.com</span>
                      </td>
                    </tr>
                  </tfoot>
                </table>
